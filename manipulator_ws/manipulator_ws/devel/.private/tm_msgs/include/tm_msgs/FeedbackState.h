...
struct FeedbackState_
{
  ...
  _disconnection_times_type disconnection_times;
   ...
   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _joint_pos_type;
  _joint_pos_type joint_pos;

   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _joint_vel_type;
  _joint_vel_type joint_vel;

   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _joint_tor_type;
  _joint_tor_type joint_tor;

   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _tool0_pose_type;
  _tool0_pose_type tool0_pose;

   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _tool_pose_type;
  ...
  _tcp_force_type tcp_force;
   ...
   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _joint_tor_average_type;
  _joint_tor_average_type joint_tor_average;

   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _joint_tor_min_type;
  _joint_tor_min_type joint_tor_min;

   typedef std::vector<double, typename ContainerAllocator::template rebind<double>::other >  _joint_tor_max_type;
  ...
  _robot_light_type robot_light;
   ...
   typedef std::vector<uint8_t, typename ContainerAllocator::template rebind<uint8_t>::other >  _cb_digital_output_type;
  _cb_digital_output_type cb_digital_output;

   typedef std::vector<uint8_t, typename ContainerAllocator::template rebind<uint8_t>::other >  _cb_digital_input_type;
  _cb_digital_input_type cb_digital_input;

   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _cb_analog_output_type;
  _cb_analog_output_type cb_analog_output;

   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _cb_analog_input_type;
  _cb_analog_input_type cb_analog_input;

   typedef std::vector<uint8_t, typename ContainerAllocator::template rebind<uint8_t>::other >  _ee_digital_output_type;
  _ee_digital_output_type ee_digital_output;

   typedef std::vector<uint8_t, typename ContainerAllocator::template rebind<uint8_t>::other >  _ee_digital_input_type;
  _ee_digital_input_type ee_digital_input;

   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _ee_analog_output_type;
  _ee_analog_output_type ee_analog_output;

   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _ee_analog_input_type;
  _ee_analog_input_type ee_analog_input;

   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _error_content_type;
...
struct Printer< ::tm_msgs::FeedbackState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::tm_msgs::FeedbackState_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.error_content);
  }
};
